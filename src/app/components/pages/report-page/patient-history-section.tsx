...
export function PatientHistorySection({ formData, updateFormData }: PatientHistorySectionProps) {
  return (
    <div className="space-y-6">
      <div>
        <CardTitle className="text-xl mb-2">Historial Médico del Paciente</CardTitle>
        <CardDescription>
          Proporcione información sobre el historial médico, medicamentos y alergias del paciente.
        </CardDescription>
      </div>
